    ...
    <template v-slot:modal-content>
      <div class="modal-content">
        ...
        <div class="condition">
          ...
          <div class="radio-group">
            <input type="radio" id="yesBroken" name="condition" value="yes" />
            <label for="yes">Ja</label>
...
export default {
  ...
  methods: {
    ...mapActions("ratingStore", ["createRating"]),
    ...
    changeStar(event) {
      ...
      for (let i = 1; i <= 5; i++) {
        if (i <= starId) {
          if (
            (starId == i &&
              this.stars[starId - 1] == true &&
              this.stars[i] == false) ||
            (this.stars[starId - 1] == true && starId == 5 && i == 5)
          ) {
