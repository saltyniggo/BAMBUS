<template>
     <base-content-container class="ratings">
          ...
          <template v-slot:body>
            <div class="body">
              <div class="text">
                <textarea name="editRating" id="editRating" cols="55" rows="5" maxlength="200" v-model="comment"></textarea>
              ...
              <div class="buttons">
                ...
                <base-rectangle-button @click="toggleEditStatus">Abbrechen</base-rectangle-button>
              </div>
            </div>
          </template>
...
export default {
    ...
    data() {
        return {
            ...
            creatorId: this.rating.creatorId,
